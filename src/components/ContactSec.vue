    ...
    <div class="contact-container">
      <div class="contact-info" :class="{ visible: infoVisible }">
        ...
        <p class="contact-description">
          Ready to collaborate on your next project? I'm always excited to work
          on innovative web solutions and bring creative ideas to life. Let's
          discuss how we can make your vision a reality.
        </p>

        <div class="contact-details">
          <a href="mailto:miguelmarionray@gmail.com" class="email-link">
            miguelmarionray@gmail.com
...
export default {
  ...
  setup() {
    ...
    const socialLinks = [
      {
        name: "LinkedIn",
        href: "https://www.linkedin.com/in/marion-ray-miguel-433b1527a/",
      ...
      {
        name: "JobStreet",
        href: "ph.jobstreet.com/profiles/marionray-miguel-vSj33XYHZN",
      ...
      {
        name: "GitHub",
        href: "https://github.com/marion-miguel",
    ...
    const handleSubmit = () => {
      if (
        ...
        const subject = encodeURIComponent(
          `Portfolio Contact from ${formData.value.name}`
        );
        ...
        const to = encodeURIComponent("marionraymiguel@gmail.com");
